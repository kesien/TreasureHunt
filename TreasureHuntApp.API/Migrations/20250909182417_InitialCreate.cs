        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowTeamTracking = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_AccessCode_EventId",
                table: "Teams",
                columns: new[] { "AccessCode", "EventId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_TeamId_LocationId",
                table: "Visits",
                columns: new[] { "TeamId", "LocationId" },
                unique: true);
        }
